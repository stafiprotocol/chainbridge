...
- chainbridge `v1.0.0` binary (see [README](https://github.com/stafiprotocol/chainbridge/#building))
...
- cb-sol-cli (see [README](https://github.com/stafiprotocol/chainbridge-deploy/tree/master/cb-sol-cli#cb-sol-cli-documentation))
