...
var (
	...
	bep20Contract     = common.HexToAddress("0x2E7EC0D5E15f044C1f7C138c1045D424380540Fe")
...
func TestSetUpBscFis(t *testing.T) {
	...
	//err = ethutils.Erc20Approve(client, bep20Contract, bscErc20Handler, mintAmount)
	//if err != nil {
	//	t.Fatal(err)
	//}

	//err = ethutils.Erc20AddMinter(client, bep20Contract, bscErc20Handler)
	//if err != nil {
	//	t.Fatal(err)
	//}
	//
	...
	rIds := [][32]byte{nativeResouceId}
	tokens := []common.Address{bep20Contract}
...
func TestBscFisDepositEvent(t *testing.T) {
	...
	depositAmount := big.NewInt(0).Mul(big.NewInt(1), big.NewInt(1000000000000000000))
	/// Stafi recepient
	//recepient := hexutil.MustDecode("0x3673009bdb664a3f3b6d9f69c9dd37fc0473551a249aa48542408b016ec62b2e")
